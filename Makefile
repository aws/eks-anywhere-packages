...
## Generate mocks
.PHONY: mocks
mocks: mockgen controllers/mocks/client.go controllers/mocks/manager.go pkg/driver/mocks/packagedriver.go pkg/bundle/mocks/client.go pkg/packages/mocks/manager.go
