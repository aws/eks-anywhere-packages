...
//		bundle, _, err := file.GivenPackageBundle("testdata/packagebundle_valid.yaml")
//		if err != nil {
...
//		bundle, _, _ := file.GivenPackageBundle("testdata/packagebundle_valid.yaml")
...
//		bundle, _, _ := tefilestutil.GivenPackageBundle("testdata/packagebundle_valid.yaml")
...
//		bundle, expectedDigest, err := file.GivenPackageBundle("testdata/packagebundle_valid.yaml")
